...
<div class="categories">
    <div class="title-container">
        <h1 id="title">Wende Electronics</h1>
  ...
  <?php  foreach ($result as $product): ?>
             ...
             <?php if($product["productCategory"]=="electronics"){?>
            ...
            <input type=number name="quantity" value="1" min="1" max="<?=$product['quantity']?>" class="form-control"/>
             ...
             <?php } elseif($product["productCategory"]=="electronics1"){?>
...
<div class="categories">
   ...
   <?php if($product["productCategory"]=="stationary"){?>
        <div class="item-container">
            <div class="card-item">
            <img src="../assets/img/<?=$product['image']?>" alt="img" id="card-img" name="img"/> 
            <?php echo '<p id="item-name" name="pname">'.$product['productName'].'</p>';?>
       ...
       <?php } elseif($product["productCategory"]=="stationary1"){?>
...
<div class="map">
	<p><b>Google map:</b></p>
	<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3942.0637832485368!2d38.81995531473559!3d8.873654593846037!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x164b7745bba4d8af%3A0x2ee2263f58cbb07b!2sAbi%20stationary!5e0!3m2!1sam!2set!4v1640719844941!5m2!1sam!2set" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            </div>
		</div>
</div>
</section>

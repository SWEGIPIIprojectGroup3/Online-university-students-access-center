...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html"><img src="../logo.jpg"/></a></h1>
        ...
        <ul>
          <li><a href="../index.php">Home</a></li>
                    <li><a href="aboutusneww.html">About Us</a></li>
                     ...
                     <button class="open-button" onclick="openForm()">Rate us</button>
  ...
  <div class="form-popup" id="myForm">
    ...
    if (isset($_POST["providername"]) && isset($_POST["stars"])) {
      if ($_STARS->save($_POST["providername"], $uid, $_POST["stars"])) {
    ...
    <?php }
    ?>
     <button type="button" class="btncancel" onclick="closeForm()">Close</button></div>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="card-body">
          ...
          <h4><a href="../forms/feed.php">Feedback</a></h4>

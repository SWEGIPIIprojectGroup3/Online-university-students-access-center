...
<body>
  ...
  if(empty($user)){
    ...
    header("Location: ../public/Laundaryform.html");
    exit();
}
else{
  ...
  if (mysqli_num_rows($result) === 1) {
    ...
    if ($row['userName'] === $user) {
      foreach($result as $data){
        ...
        $sql="INSERT INTO laundarypay(user_id,username,phone,clothes,Date) VALUES('$id','$user','$phone','$clothes','$date');";
        mysqli_query($conn,$sql);
        echo "You've booked your appointment successfully";
          }}
   else {
